...
PATTERNS = (
    ...
    (re.compile(r"/home/" r"ubuntu/"), "private absolute path"),
    (re.compile(r"(?i)\b(?:coding " r"agent|ai-" r"generated|generated by (?:an )?(?:ai|automation))\b"), "automated attribution marker"),
    (re.compile(r"(?i)(?:Live systems " r"touched|Live changes " r"made|Review prove" r"nance)"), "internal review protocol"),
